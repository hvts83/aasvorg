var rsr = Raphael('map', '1000', '546');

var regions = [];

var clickSanmiguel = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/SanMiguel.html";
};
var clicklaunion = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/launion.html";
};
var clicksansalvador = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/sansalvador.html";
};
var clicksonsonate = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/sonsonate.html";
};
var clicksantaana = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/santaana.html";
};
var clickahuachapan = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/ahuachapan.html";
};
var clicklalibertad = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/lalibertad.html";
};
var clickcuscatlan = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/cuscatlan.html";
};
var clickcabanas = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/cabanas.html";
};
var clicksanvicente = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/sanvicente.html";
};
var clickmorazan = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/morazan.html";
};
var clicklapaz = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/lapaz.html";
};
var clickchalatenango = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/chalatenango.html";
};
var clickSanmiguel = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/SanMiguel.html";
};
var clickusulutan = function(){
	window.location.href = "http://www.aaelsalvador.org/Map/usulutan.html";
};
// ahuachapan
...
ahuachapan.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
ahuachapan.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'ahuachapan', 'region': 'ahuachapan'});
...
santaana.attr({fill: '#8B0000','stroke-width': '0','stroke-opacity': '1'});
...
sonsonate.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
...
chalatenango.attr({fill: '#8B0000','stroke-width': '0','stroke-opacity': '1'});
...
lalibertad.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
lalibertad.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'lalibertad', 'region': 'lalibertad'});
...
sansalvador.attr({fill: '#FF6666','stroke-width': '0','stroke-opacity': '1'});
...
cuscatlan.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
cuscatlan.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'cuscatlan', 'region': 'cuscatlan'});
...
cabañas.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
...
lapaz.attr({fill: '#8B0000','stroke-width': '0','stroke-opacity': '1'});
...
sanvicente.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
...
usulutan.attr({fill: '#8B0000','stroke-width': '0','stroke-opacity': '1'});
usulutan.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'usulutan', 'region': 'usulutan'});
...
morazan.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
morazan.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'morazan', 'region': 'morazan'});
...
launion.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
launion.transform("m0.900176, 0, 0, 0.900176, 85.6568, 56.7095").data({'id': 'launion', 'region': 'la union'});
...
sanmiguel.attr({fill: '#CC3300','stroke-width': '0','stroke-opacity': '1'});
...
for (var i = 0; i < regions.length; i++) {
    ...
    if (regions[i].data('id') == 'lalibertad') {
